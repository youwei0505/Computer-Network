...
int main(int argc , char *argv[])
{
	...
	cout << i << endl; 	
    cout <<"new _ change the port to " << server_port;  
    server_socket = socket(AF_INET ,SOCK_DGRAM ,0);
    //socket的連線
	...
	server_addr.sin_addr.s_addr = inet_addr("127.0.1.2");
    ...
    cout << "listening....." << endl;    
   	cout << "starting three-way handshake.....\n" << endl;
   	//wait for SYN
   	//1st
    cout << "Received Waitinnnnng  -------  " << i << "    ----" <<endl;  
